...
export default function CategoryPage() {
  ...
  async function loadProducts() {
    try {
      setLoading(true);
      const res = await productService.getProducts({ category: slug, page, pageSize: 20 });
    ...
    <motion.div {...pageTransition}>
      <div className="bg-neutral-50/50 dark:bg-neutral-900/30 border-b border-neutral-100 dark:border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <p className="text-xs font-medium text-primary-500 uppercase tracking-widest mb-2">Category</p>
